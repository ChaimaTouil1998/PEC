...
Public Class fichehisEc_super
    ...
    Public Sub Alimenter()
        ...
        commandtext1 = "Select * from ecart_disciplinaire where id_eleve = " & txtId.Text
        ...
        Using Connexion As OdbcConnection = New OdbcConnection(connectionString)
            ...
            If lire1.Read() Then
                If lire1("sanction") IsNot System.DBNull.Value Then sanction.Text = lire1("sanction")
    ...
    Private Sub btnUndo_Click(sender As Object, e As EventArgs) Handles btnUndo.Click
        Response.Redirect("~\histEC_super.aspx")
    End Sub
