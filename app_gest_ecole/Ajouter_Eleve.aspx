<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Ajouter_Eleve.aspx.vb" Inherits="app_gest_ecole.Ajouter_Eleve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <div class="col">
            <div class="form-group">
                <asp:Label Text="Genre :    " ID="Label25" runat="server" ForColor="Black"></asp:Label>

                <asp:CheckBox Text="Male" ID="male" runat="server"  ForColor="Black"/>
                <asp:CheckBox Text="Femelle " ID="femelle" runat="server" ForColor="Black"/>
            </div>
        </div>
    </div>
    <div class="row text-left" style="padding-left: 70px">
