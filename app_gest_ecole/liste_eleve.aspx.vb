...
Public Class liste_eleve
    ...
    Private Sub grdListe_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles grdListe.RowCommand
        ...
        If (e.CommandName = "OpenLg") Then
            ...
            Dim k As Integer
            k = grdListe.DataKeys(index).Value.ToString
            Response.Redirect("~\Fiche_eleve_super.aspx?id_eleve=" & k)
        End If
        ...
        If (e.CommandName = "OpenEC") Then
            ...
            Dim k As Integer
            k = grdListe.DataKeys(index).Value.ToString
            Response.Redirect("~\Fiche_Ecart_dis_super.aspx?id_eleve=" & k)
        End If
        ...
        If (e.CommandName = "OpenIn") Then
            ...
            Dim k As Integer
            k = grdListe.DataKeys(index).Value.ToString
            Response.Redirect("~\Fiche_Incident_super.aspx?id_eleve=" & k)
        End If
        ...
        If (e.CommandName = "OpenAb") Then
            ...
            Dim k As Integer
            k = grdListe.DataKeys(index).Value.ToString
            Response.Redirect("~\Fiche_Absence_super.aspx?id_eleve=" & k)
        End If
        ...
        If (e.CommandName = "OpenB") Then
            ...
            Dim k As Integer
            k = grdListe.DataKeys(index).Value.ToString
            Response.Redirect("~\Fiche_Bulltin_super.aspx?id_eleve=" & k)
        End If
    End Sub
