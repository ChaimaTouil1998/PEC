...
Public Class fichehisInc_super
    ...
    Public Sub Alimenter()
        ...
        commandtext1 = "Select description,date from incident where id_eleve = " & txtId.Text
        ...
        Using Connexion As OdbcConnection = New OdbcConnection(connectionString)
            ...
            If lire1.Read() Then
                If lire1("description") IsNot System.DBNull.Value Then desc.Text = lire1("description")
                If lire1("date") IsNot System.DBNull.Value Then txtDateInc.Text = lire1("date")
            End If
            lire1.Close() ' Fermer le deuxième lecteur de données
        End Using
    End Sub
    Private Sub btnUndo_Click(sender As Object, e As EventArgs) Handles btnUndo.Click
        Response.Redirect("~\histInc_super.aspx")
    End Sub
