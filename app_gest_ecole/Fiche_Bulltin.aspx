<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche_eleve_admin.Master" CodeBehind="Fiche_Bulltin.aspx.vb" Inherits="app_gest_ecole.Fiche_Bulltin" %>
        ...
        <div class="col-md-12" >
            <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                                                        <label for="dpAn" style="color: black; padding-right: 180px">Année Scolaire Courant:</label>

                                            <asp:DropDownList ID="dpAn" Style="border-color: #1A3B86" CssClass="form-control" runat="server" DataSourceID="sqlan" DataTextField="libelle_an" DataValueField="code">
                                            </asp:DropDownList>
