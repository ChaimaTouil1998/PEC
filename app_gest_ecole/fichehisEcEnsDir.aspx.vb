...
Public Class fichehisEcEnsDir
    ...
    Public Sub Alimenter()
        ...
        commandtext1 = "Select * from sanction where id_enseignant = " & txtId.Text
        ...
        Using Connexion As OdbcConnection = New OdbcConnection(connectionString)
            ...
            If lire1.Read() Then
                If lire1("observation") IsNot System.DBNull.Value Then Sanction.Text = lire1("observation")
                If lire1("date_fait") IsNot System.DBNull.Value Then datefait.Text = lire1("date_fait")
            End If
    ...
    Private Sub btnUndo_Click(sender As Object, e As EventArgs) Handles btnUndo.Click
        Response.Redirect("~\histSEnsDir.aspx")
    End Sub
