<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="liste_enseignant_super.aspx.vb" Inherits="app_gest_ecole.liste_enseignant" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" >
        <div class="auto-style1">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>" SelectCommand="SELECT  [id_enseignant],[prenom], [nom], [genre], [Num_tel], Specialite.libelle as Specialite FROM [Enseignants] , Specialite WHERE Enseignants.specialite = Specialite.Code"></asp:SqlDataSource>
    ...
    <div class="row text-left" >
        <div class="col-md-12">
            ...
            <Columns>
                <asp:BoundField DataField="id_enseignant" HeaderText="id_enseignant" SortExpression="id_enseignant" Visible="false" />
