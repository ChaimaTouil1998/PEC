<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="histAbsEnsAdmin.aspx.vb" Inherits="app_gest_ecole.histAbsEnsAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; LA LISTE DES ENSEIGNANTS </h2>
        <br />
        <br />
        <br />
    </div>
    ...
    <asp:SqlDataSource ID="sqlEnseignant" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>" SelectCommand="SELECT [id_enseignant], [prenom], [nom],[genre] FROM [Enseignants]"></asp:SqlDataSource>
