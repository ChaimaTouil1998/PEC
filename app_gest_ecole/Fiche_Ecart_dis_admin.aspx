<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche_eleve_admin.Master" CodeBehind="Fiche_Ecart_dis_admin.aspx.vb" Inherits="app_gest_ecole.Fiche_Ecart_dis_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        &nbsp;
        <h2 style="color: #D32A27; display: inline; text-align: left">ÉCART DISCIPLINAIRE</h2>
        <br />
        <br />
        <br />
    </div>
        ...
        <div class="col-md-12">
            <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
                       ...
                       <asp:SqlDataSource ID="sqlan" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>"
                           ...
                           <SelectParameters>
                            ...
                            <asp:TextBox ID="txtdate" class="form-control form-control-user" aria-describedby="emailHelp"
                                placeholder="Date" runat="server" Style="border-color: #1A3B86" ></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="txtdate_CalendarExtender" Format="dd/MM/yyyy"  runat="server" BehaviorID="txtdate_CalendarExtender" TargetControlID="txtdate"></ajaxToolkit:CalendarExtender>
                        </div>
                                     </div>
                                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                <asp:Label Text="La Fiche d'inconduite" ID="Label4" runat="server"></asp:Label>
