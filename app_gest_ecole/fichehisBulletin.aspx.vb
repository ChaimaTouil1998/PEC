...
Public Class fichehisBulletin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            If Session.Item("id_eleve") IsNot System.DBNull.Value Then
                txtId.Text = Request.QueryString("id_bul")
                Alimenter()
    ...
    Public Sub Alimenter()
        ...
        commandtext = "Select bulletin.*, eleve.classe_actuel, date_naissance, prenom, nom  from bulletin, eleve where bulletin.id_eleve = eleve.id_eleve and  id_bul = " & txtId.Text
        ...
        End Using
        sql.SelectCommand = "Select bulletin.*, eleve.classe_actuel, date_naissance, prenom, nom  from bulletin, eleve where bulletin.id_eleve = eleve.id_eleve and  id_bul =  " & txtId.Text
        sql.DataBind()
        grdListe.DataBind()
    End Sub
    ...
    Private Sub btnUndo_Click(sender As Object, e As EventArgs) Handles btnUndo.Click
        Response.Redirect("~\lstbulletin.aspx")
    End Sub
