<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Enseignant.Master" CodeBehind="histECEns.aspx.vb" Inherits="app_gest_ecole.histECEns" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; LISTE DES ECART DISCIPLINAIRES DES ELEVES</h2>
        <br />
        <br />
        <br />
    </div>
    <div class="row text-left" style="padding-left: 740px">
        <asp:SqlDataSource ID="sql" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>" SelectCommand="SELECT ecart_disciplinaire.id_ecart,ecart_disciplinaire.date,ecart_disciplinaire.sanction,ecart_disciplinaire.description ,eleve.nom, eleve.prenom FROM ecart_disciplinaire JOIN eleve ON ecart_disciplinaire.id_eleve = eleve.id_eleve"></asp:SqlDataSource>
        ...
        <div class="row text-left" style="padding-left: 60px">
            <div class="col-md-12">
                ...
                <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-left" AutoGenerateColumns="False" DataKeyNames="id_ecart" DataSourceID="sql" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                    <AlternatingRowStyle BackColor="#DCDCDC" />
                    <Columns>
                        <asp:BoundField DataField="nom" HeaderText="nom" SortExpression="nom" />
                        <asp:BoundField DataField="prenom" HeaderText="prenom" SortExpression="prenom" />
                        <asp:BoundField DataField="date" HeaderText="date" SortExpression="date" />
                        <asp:BoundField DataField="sanction" HeaderText="sanction" SortExpression="sanction" />
