<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche_eleve_admin.Master" CodeBehind="lstInc.aspx.vb" Inherits="app_gest_ecole.lstInc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
      ...
      <asp:SqlDataSource ID="sqlEleve" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>" SelectCommand="SELECT [id_incident], [date], [An], eleve.[id_eleve], [description], Annee_scolaire.libelle_An, eleve.nom + ' ' + eleve.prenom as nomsal  FROM [incident], annee_scolaire, eleve WHERE incident.id_eleve = eleve.id_eleve and incident.an = annee_scolaire.code and  ((incident.[id_eleve] = ?) AND (incident.[An] = ?)) order by date desc" >
          <SelectParameters>
    ...
    <div class="row text-left" style="padding-left: 60px">
        <div class="col-md-12">
            <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-left" AutoGenerateColumns="False" DataSourceID="sqlEleve" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" DataKeyNames="id_incident">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="date" HeaderText="Date d'effet" SortExpression="date_ab" DataFormatString="{0:d}" />
                    <asp:TemplateField>
                        <HeaderTemplate>
