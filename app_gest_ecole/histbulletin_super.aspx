<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="histbulletin_super.aspx.vb" Inherits="app_gest_ecole.histbulletin_super" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; Les bulletins de chaque élève</h2>
        <br />
        <br />
        <br />
    </div>
