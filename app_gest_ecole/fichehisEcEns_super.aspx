<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="fichehisEcEns_super.aspx.vb" Inherits="app_gest_ecole.fichehisEcEns_super" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <div class="col">
            <div class="form-group">
                <label for="sanction" style="color:black">Observation:</label>
                <asp:TextBox ID="sanction" class="form-control form-control-user" TextMode="MultiLine" aria-describedby="emailHelp"
                    runat="server" Style="border-color: #1A3B86" ReadOnly="true"></asp:TextBox>
        ...
        <div class="col">
             <div class="form-group">
                <label for="txtDat" style="color:black">Date de fait:</label>
                <asp:TextBox ID="datefait" class="form-control form-control-user" aria-describedby="emailHelp"
                    runat="server" Style="border-color: #1A3B86" ReadOnly="true"></asp:TextBox>
