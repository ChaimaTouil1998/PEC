<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Ajouter_specialite.aspx.vb" Inherits="app_gest_ecole.Ajouter_specialite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        <div class="col-md-12" style="padding-left: 400px; padding-right: 400px">
            <div class="card" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
                <h6 style="color: #1A3B86; display: inline; text-align: center; font-weight: bold; padding-bottom: 30px">UNE NOUVELLE SPÉCIALITÉ</h6>
                <div class="form-group">
                    <asp:TextBox ID="txtNvlSpec" class="form-control form-control-user" aria-describedby="emailHelp"
                        placeholder="Nom De La Nouvelle Spécialité" runat="server" style="border-color: #1A3B86"></asp:TextBox>
                </div>
                <div class="row text-left" style="padding-left: 170px; padding-top: 50px">
    ...
    <br />
<div class="row text-left" style="padding-left:50px">
    ...
    <div class="row text-left" style="width:1500px">
        <div class="col-md-12">
            <asp:GridView ID="grdListe" runat="server" class="table table-bordered text-left" AutoGenerateColumns="False" DataKeyNames="Code" DataSourceID="sqlspec" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
