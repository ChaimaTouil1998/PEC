<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="histInc_super.aspx.vb" Inherits="app_gest_ecole.histInc_super" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; La liste des élèves</h2>
        <br />
        <br />
        <br />
    </div>
