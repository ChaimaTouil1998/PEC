...
Public Class fichehisAbs_super
    ...
    Public Sub Alimenter()
        ...
        commandtext1 = "Select duree,date_ab from absence where id_eleve = " & txtId.Text
        ...
        Using Connexion As OdbcConnection = New OdbcConnection(connectionString)
            ...
            If lire1.Read() Then
                ...
                If lire1("date_ab") IsNot System.DBNull.Value Then txtDat.Text = lire1("date_ab")
            End If
