<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="fichehisBulletin.aspx.vb" Inherits="app_gest_ecole.fichehisBulletin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style=";padding-left: 70px">
       <div class="col">
            <asp:SqlDataSource ID="sql" runat="server" ConnectionString="<%$ ConnectionStrings:EcoleConnectionString %>" ProviderName="<%$ ConnectionStrings:EcoleConnectionString.ProviderName %>" SelectCommand="SELECT id_bul,eleve.id_eleve,id_eleve,bulletinTrim1,bulletinTrim2,bulletinTrim3 FROM bulletin,  id_eleve Where bulletin.id_eleve = eleve.id_eleve and eleve.id_eleve = 0">
