<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin.Master" CodeBehind="Ajouter_Eleve_admin.aspx.vb" Inherits="app_gest_ecole.Ajouter_Eleve_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <div class="col">
            <div class="form-group">
                <br />
                <label for="" style="color: black">Genre:</label><br />
