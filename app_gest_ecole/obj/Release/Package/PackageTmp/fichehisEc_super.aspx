<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="fichehisEc_super.aspx.vb" Inherits="app_gest_ecole.fichehisEc_super" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; Ecart Disciplinaire pour chaque Elève</h2>
        <br />
        <br />
        <br />
    </div>
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <div class="col">
            <div class="form-group">
                <label for="sanction" style="color:black">Sanction:</label>
                <asp:TextBox ID="sanction" class="form-control form-control-user" aria-describedby="emailHelp"
                    runat="server" TextMode="MultiLine" Style="border-color: #1A3B86" ReadOnly="true"></asp:TextBox>

            </div>
        </div>
        <div class="col">
            <div class="form-group">
                <label for="sanction" style="color:black">Description de la Sanction:</label>
                <asp:TextBox ID="desc" class="form-control form-control-user" aria-describedby="emailHelp"
                    runat="server" TextMode="MultiLine" Style="border-color: #1A3B86" ReadOnly="true"></asp:TextBox>
