<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="absence_super.aspx.vb" Inherits="app_gest_ecole.absence_super" %>
                    ...
                    <div class="col">
                       ...
                       <div class="col">
                        ...
                        <div class="form-group">
                            ...
                            <ajaxToolkit:CalendarExtender ID="TextBox1_CalendarExtender" Format="dd/MM/yyyy"  runat="server" BehaviorID="TextBox1_CalendarExtender" TargetControlID="TextBox1"></ajaxToolkit:CalendarExtender>
                        </div>
