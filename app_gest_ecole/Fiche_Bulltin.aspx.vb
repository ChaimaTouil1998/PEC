...
Public Class Fiche_Bulltin
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If Integer.TryParse(txtId.Text, id) Then
            ...
            Dim commandtext As String = "INSERT INTO bulletin (bulletinTrim1, bulletinTrim2, bulletinTrim3, id_eleve,An) VALUES (" &
                                            "'" & txtChemin1.Text.Replace("'", "''") & "', " &
                                            "'" & txtChemin2.Text.Replace("'", "''") & "', " &
                                            "'" & txtChemin3.Text.Replace("'", "''") & "',  " & id & ", " & dpAn.SelectedValue & ")"
