<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche.Master" CodeBehind="fichehisAbsDir.aspx.vb" Inherits="app_gest_ecole.fichehisAbsDir" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <h2 style="color: #1A3B86; display: inline; text-align: left">&nbsp; Absence Elève</h2>
        <br />
        <br />
        <br />
    </div>
    ...
    <div class="row text-left" style="padding-left: 70px">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <asp:TextBox ID="txtDatAbs" class="form-control form-control-user" aria-describedby="emailHelp"
