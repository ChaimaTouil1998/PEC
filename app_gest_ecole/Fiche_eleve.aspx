<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/fiche_eleve_admin.Master" CodeBehind="Fiche_eleve.aspx.vb" Inherits="app_gest_ecole.Fiche_eleve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grd" class="table table-bordered" ForeColor="Black" runat="server" AutoGenerateColumns="False" DataSourceID="sqlDoc" DataKeyNames="id_eleve,fichier_image">
    <Columns>
        <asp:BoundField DataField="fichier_image" HeaderText="Photo Elève(Format: JPEG,JPG,PNG)" SortExpression="fichier_image" />
          <asp:TemplateField>
                 <ItemTemplate>
    ...
    <asp:GridView ID="grdDoc" class="table table-bordered" runat="server" ForeColor="Black" AutoGenerateColumns="False" DataSourceID="sql" DataKeyNames="id_eleve,fichier">
    <Columns>
    ...
    <div class="row text-left" style="padding-left: 70px">
        <div class="col">
                    <asp:LinkButton ID="btnSave" Text="MODIFIER" class="d-none d-sm-inline-block btn btn-primary shadow-sm" Style="background-color: #1A3B86; width: 350px; border-radius: 10px" runat="server"></asp:LinkButton>
